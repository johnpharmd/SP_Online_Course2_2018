...
def login_mongodb_cloud():
    ...
    try:
        ...
        log.info('Successully connected and logged in to mongodb.')

    except Exception as e:
        print(f'error: {e}')

    client = pymongo.MongoClient(f'mongodb://{user}:{pw}'
                                 '@cluster0-shard-00-00-h3x0e.mongodb.net:27017,'
                                 'cluster0-shard-00-01-h3x0e.mongodb.net:27017,'
                                 'cluster0-shard-00-02-h3x0e.mongodb.net:27017/test'
...
def login_neo4j_cloud():
    ...
    graphenedb_url = 'bolt://hobby-ipopagjhhihbgbkeffmjlpbl.dbs.graphenedb.com:24786'
